...
hashivault_tls_kv_plugin = CredentialPlugin('HashiCorp Vault Secret Lookup with TLS', inputs=hashi_kv_inputs, backend=kv_backend)

hashivault_tls_ssh_plugin = CredentialPlugin('HashiCorp Vault Signed SSH with TLS', inputs=hashi_ssh_inputs, backend=ssh_backend)
